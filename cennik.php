        ...
        <div class="price-list" id="cennik">
            <div class="priceSection">
                <div class="sectionTitle" data-aos="fade-up">
                    <div class="title">Icoone</div>
                </div>
                <div class="sectionSubTitle" data-aos="fade-down">
                    <div class="title2"><span class="markAsNew">*NOWOŚĆ*</span> Icoone ciało</div>
                </div>

                <div class="sectionContent">
                    <div class="sellingItem" data-aos="fade-right">
                        <div class="priceName">
                            <div class="title3">1 zabieg </div>
                            <div class="priceDesc">
                                <p>Baza + 2 Focusy</p>
                            </div>
                        </div>
                    ...
                    <div class="sellingItem" data-aos="fade-left">
                        ...
                        <div class="cost">
                            <div class="title3">350 zł</div>
                        </div>
                    </div>
                    <div class="sellingItem" data-aos="fade-right">
                        <div class="priceName">
                            <div class="title3">5 zabiegów </div>
                            <div class="priceDesc">
                                <p>Baza + 2 Focusy</p>
                            </div>
                        </div>
                    ...
                    <div class="sellingItem" data-aos="fade-left">
                        ...
                        <div class="cost">
                            <div class="title3">2400 zł</div>
                        </div>
                    </div>
                </div>
                <div class="sectionSubTitle" data-aos="fade-down">
                    <div class="title2"><span class="markAsNew">*NOWOŚĆ*</span> Icoone twarz</div>
                </div>
                <div class="sectionContent">
                    <div class="sellingItem" data-aos="fade-right">
                        <div class="priceName">
            ...
            <div class="priceSection">
                ...
                <!--  -->
                <div class="sectionSubTitle" data-aos="fade-down">
                    <div class="title2">Kwas migdałowy</div>
                </div>
                <div class="sectionContent">
                    <div class="sellingItem" data-aos="fade-left">
                        <div class="priceName">
                            <div class="title3">Twarz</div>
                            <div class="priceDesc">
                                <p>3 kwasy</p>
                            </div>
                        </div>
                        <div class="cost">
                            <div class="title3">270 zł</div>
                        </div>
                    </div>
                    <div class="sellingItem" data-aos="fade-left">
                        <div class="priceName">
                            <div class="title3">Twarz, szyja, dekolt </div>
                            <div class="priceDesc">
                                <p>3 kwasy</p>
                            </div>
                        </div>
                        <div class="cost">
                            <div class="title3">370 zł</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="priceSection">
                ...
                <div class="sectionSubTitle" data-aos="fade-down">
                    <div class="title2">Thermogenique</div>
                </div>
                <div class="sectionContent">
                    <div class="sellingItem" data-aos="fade-right">
