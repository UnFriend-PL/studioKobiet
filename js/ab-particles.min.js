function particles() {
    ...
    const n = document.getElementById("particles"),
        o = n.getContext("2d");
    let s;
    ...
    window.addEventListener("mousemove", function(e) { d.x = e.x, d.y = e.y });
    class l {
        constructor(e, t, i, n, o) { this.x = e, this.y = t, this.directionX = i, this.directionY = n, this.size = o }
        draw() { o.beginPath(), o.arc(this.x, this.y, this.size, 0, 2 * Math.PI, !1), o.fillStyle = e, o.fill() }
        update() {
    ...
    function r() {
        ...
        for (let t = 0; t < e * numParticles; t++) {
            let e = Math.random() * sizeMultiplier + 1,
                t = Math.random() * (innerWidth - 2 * e - 2 * e) + 2 * e;
    ...
    window.addEventListener("resize", function() { n.width = innerWidth, n.height = innerHeight, d.radius = n.height / 80 * (n.width / 80), r() }), window.addEventListener("mouseout", function() { d.x = void 0, d.y = void 0 }), r(),
        function e() {
